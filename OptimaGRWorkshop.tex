...
dy + \textrm{Maximise}_{\, x\geq 0 \,} \{ c^tx  : Ax \leq b -
By\}\, \},
\end{eqnarray*}
...
d\overline{y} + \textrm{Minimise}_{\, u\geq 0 \,} \{ u(b-B\overline{y})
: uA \geq c\}\, \}.
\end{eqnarray*}
...
In the first case, we obtain an extreme point $u^p$. In the latter situation, there is a direction $r^q$ for which $r^q(b-B\overline{y}) > 0$.  \cite{costa09benders}. 
